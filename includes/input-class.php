...
?>
  ...
  public function text_pk(string $label,string $name='',string $param = '', array $options = array('m', 12))
  {
    if ($name === '') {
      $name = $label;
    }
  ...
  ?>
    ...
    <div class="col-<?php echo $options[1] ?>">
      <div class="input-group mb-3 <?php echo (isset($size)) ? $size : null ?>">
        <span class="input-group-text <?php echo (isset($size)) ?  $size : null ?>"><?php echo $label ?></span>
        <input type="text" name="<?php echo $name ?>" value="" class="form-control <?php echo (isset($size)) ?  $size : null ?> " <?php echo $param ?>>
      </div>
    </div>
  <?php
  ...
  public function email_val_pk($table, $where, $value, $label, $name, $param, $options = array('m', 12))
  {
    ...
    $value_validate = $this->validate_email_pk($value_input[0][$name]);
  ?>
    <div class="col-<?php echo $options[1] ?>">
      <div class="input-group mb-3 <?php echo $size ?>">
        <span class="input-group-text <?php echo $size ?>"><?php echo $label ?></span>
        <input type="email" name="<?php echo $name ?>" value="<?php echo $value_validate ?>" class="form-control" <?php echo $param ?>>
      </div>
    </div>
  ...
  public function option_val_pk(string $table, string $where, string $value, string $label, string $name, array $selection, string $param = '', $options = array('m', 12))
  {
  ...
  ?>
    <div class="col-<?php echo $options[1] ?>">
      <div class="input-group mb-3 <?php echo $size ?>">
        <span class="input-group-text <?php echo $size ?>"><?php echo $label ?></span>
        <select <?php echo $param ?> name="<?php echo $name ?>" class="form-select" aria-label="Default select example">
          <option selected><?php echo $value_input[0][$name] ?></option>
          <?php for ($i = 1; $i < count($selection); $i++) {
            echo " <option value='$selection[$i]'>$selection[$i]</option>";
          }
          ?>
